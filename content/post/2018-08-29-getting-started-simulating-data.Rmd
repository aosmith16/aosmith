...
Possibly out of habit from making written versions of labs and workshops as resources for students, I created a written version of the talk.  You can see the [full PDF version](https://github.com/aosmith16/simulation-helper-functions/blob/master/functions_for_simulations_detailed.pdf) at [the GitHub repository](https://github.com/aosmith16/simulation-helper-functions) I made for the talk materials.  
...
What happens if we get the number wrong?  If we're lucky we get an error.
