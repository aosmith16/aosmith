...
render_toc("2018-01-19-reversing-the-order-of-a-ggplot2-legend.Rmd")
```
...
# Change the data to change the plot?
...
# Reverse the legend in guide_legend()
...
labs = labs[!labs %in% c("setup", "toc", "getlabels", "allcode", "makescript", "example")]
```
...
Here's the code without all the discussion.  Copy and paste the code below or you can download an R script of uncommented code [from here](/script/2018-01-19-reversing-the-order-of-a-ggplot2-legend.R).
