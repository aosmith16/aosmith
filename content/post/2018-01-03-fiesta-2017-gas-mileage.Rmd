...
tags:
  ...
  - googlesheets
draft: FALSE
description: "Since January is the month for analyzing last year's data, I take a quick look at my 2017 gas mileage in my commuter car (Fiesta! `r emo::ji('celebration')`).  I use package googlesheets for reading data, skimr for a quick summary of the dataset, and ggplot2 for plotting."
---
...
Here's my first chance to use functions from package **skimr** to get a quick summary of the variables in the dataset. (The locale change is to try to get [histograms to display correctly](https://github.com/ropenscilabs/skimr/issues/136), which works in the RMD but not in HTML.)
