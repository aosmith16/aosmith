...
Here's my first chance to use functions from package **skimr** to get a quick summary of the variables in the dataset. (Starting in **skimr** 1.0.1 the histograms work in R markdown documents on Windows!)
