...
Here I'll start by getting a list of the files.  I'm using some toy files I made to mirror what the real files looked like. These CSV files are available on the [blog GitHub repository](https://github.com/aosmith16/aosmith/tree/master/content/data).
