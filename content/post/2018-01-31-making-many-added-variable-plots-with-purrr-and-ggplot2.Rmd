...
# [A function for making a prediction dataset](#a-function-for-making-a-prediction-dataset)
...
# [Making one added variable plot](#making-one-added-variable-plot)
...
# [A function for plotting](#a-function-for-plotting)
...
My plotting function has three arguments: the dataset to plot, the explanatory variable to plot on the x axis (as a string), and label for the x axis (also as a string).  Your variable names for `x` must by [syntactically valid](https://stat.ethz.ch/R-manual/R-devel/library/base/html/make.names.html) to use the `aes_string()` approach I'm demonstrating here.
